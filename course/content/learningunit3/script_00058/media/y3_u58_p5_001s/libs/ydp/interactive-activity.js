(function (wnd) {
	...
	function showSlide() {		
		...
		for(i=0;i<arr.length;i++) {
			...
			tf.setAttributeNS(null, 'transform', 'translate(' + etp.left + ' ' + (etp.top + 18) + ')');
